...
<div class="logo">
	...
	<form:form id="join-frm" action="${pageContext.request.contextPath }/member/join"
		...
		<div class="container1">
			<div class="content">
				...
				<div> 
				<form:input type="text" path="id" maxlength="30"/><i class="far fa-envelope fa-lg"></i> </div>
				<div><span class="errmsg" id="id_errmsg"></span>
				 <form:errors path="id" cssClass="errmsg" id="id_errmsg"></form:errors> </div>
				<div> <form:label path="pw">비밀번호</form:label> </div>
				<div> <form:input type="password" path="pw" maxlength="20"/><i class="fas fa-lock fa-lg"></i> </div>
				...
				<div> <form:label path="nickname">닉네임</form:label> </div>
				...
				<form:input type="text" id="sample6_postcode" placeholder="우편번호" path="region"/>
<form:input type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기" path="region"/><br>
<form:input type="text" id="sample6_address" placeholder="주소" path="region"/><br>
<form:input type="text" id="sample6_extraAddress" placeholder="참고항목" path="region"/>
<form:input type="text" id="sample6_detailAddress" placeholder="상세주소" path="region"/>
</div>
			 <%--  <div> 
				...
				<div> <span class="errmsg" id="region_errmsg"></span>
				...
				<div> <form:label path="birth">생일</form:label> </div> <div>
					<form:input type="date" name="birth" path="birth" size="40px"/> <i class="fas fa-birthday-cake"></i></div> 
				...
				<a href="<c:url value='/' />"  id="cancle"> <button id="cancle">가 입 취 소</button></a>
			</div>
		</div>
	</form:form>
    <div class="abstr"></div>
