...
<style>
	#nboardList {width:57%; padding: 10px; height: 100%;}
	#nboardList h2{ text-align: center; padding:30px 0;}
  ...
  #nboardList th:not(#nottd), td:not(#nottd) {
    border-bottom: 1px solid #444444;
    padding: 10px;
  }
	#nboardList table th:nth-child(1) { width:7%; }
/* 	#nboardList table td:nth-child(1) { text-align: right; } */
	#nboardList table th:nth-child(2) { width:8%; }
	#nboardList table th:nth-child(3) { width:36%; }
	#nboardList table td:nth-child(3):hover { text-decoration: underline; }
	#nboardList table th:nth-child(4) { width:23%; }
	#nboardList table th:nth-child(5) { width:17%; }
	#nboardList table th:nth-child(6) { width:10%; }
/* 	#nboardList table td:nth-child(6) { text-align: right; } */
	#nboardList table td:not(#nottd0){ padding:3px; text-align: center;}
	...
	#nboardList #writeBtn { width:100%; padding: 2px 3px;}
	#nboardList #paging, #nboardList #search{
		display:flex;
	...
	#nboardList #paging a:hover{
		text-decoration: underline;
	}
	#nboardList #paging a.on{
		background-color:pink;
	}
 	#nboardList #search input[type="search"]{
		width:200px;}
	
	#nboardList #search #nsearchBtn{ padding:2px; } 
...
/* 		writeBtn.addEventListener("click",function(e){
		...
		//검색버튼 클릭시
		nsearchBtn.addEventListener("click",function(e){
			e.preventDefault();
			//console.log("검색!!");
			// 검색어 입력값이 없으면
