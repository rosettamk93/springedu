...
function init(){
	...
	cancelBtn.addEventListener("click",function(e){
		e.preventDefault();
		document.getElementById("aboardVO").reset();
	},false);
	//목록버튼 클릭시
			...
			<main>
				<div class="mycontainer main-inner-box">
					<div class="mycontainer mycontainer-sc">
					  <div id="frm">
					    <div><h2>답글 작성</h2></div>
					    <form:form action="${pageContext.request.contextPath }/aboard/reply/${returnPage }" 
					    					 enctype="multipart/form-data"
					    					 method="post"
					    					 modelAttribute="aboardVO">
							<form:hidden path="boardCategoryVO.cid" value="${aboardVO.boardCategoryVO.cid }"/>					    					 
							<form:hidden path="abgroup" value="${aboardVO.abgroup }"/>					    					 
							<form:hidden path="abindent" value="${aboardVO.abindent }"/>					    					 
							<form:hidden path="abstep" value="${aboardVO.abstep }"/>					    					 
					    <div class="row">
				        ...
				        <form:input class="col-2" type="text" path="abtitle"/>
					    ...
					    <div class="row">
					      ...
					      <form:textarea class="col-2" rows="10" path="abcontent"></form:textarea>
